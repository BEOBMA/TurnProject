...
enum class KeywordType(val component: Component) {
    ...
    TrueDamage(Component.text("고정피해", TextColorType.White.textColor).decorate(TextDecoration.BOLD)),
    ...
    Emerald(Component.text("에메랄드", TextColorType.Green.textColor).decorate(TextDecoration.BOLD)),
    Continue(Component.text("지속", TextColorType.Gray.textColor).decorate(TextDecoration.BOLD)),
    Time(Component.text("시간", TextColorType.Gold.textColor).decorate(TextDecoration.BOLD)),
    Stun(Component.text("기절", TextColorType.Yellow.textColor).decorate(TextDecoration.BOLD)),
    Reforge(Component.text("재련", TextColorType.Gold.textColor).decorate(TextDecoration.BOLD)),
    Reforged(Component.text("재련됨", TextColorType.Gold.textColor).decorate(TextDecoration.BOLD)),
    Protect(Component.text("보호", TextColorType.Blue.textColor).decorate(TextDecoration.BOLD)),
    Bleeding(Component.text("출혈", TextColorType.DarkRed.textColor).decorate(TextDecoration.BOLD))
}